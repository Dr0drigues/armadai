...
/// Generate `.opencode/instructions.md` with only the team table (no coordinator system prompt).
///
/// Used when a root `.opencode/instructions.md` already exists in the project, to avoid
/// duplicating or conflicting with the user-maintained instructions. Only the `## Team`
/// section is emitted, prefixed with an auto-generated comment.
...
mod tests {
    ...
    fn test_generate_coordination_only_structure() {
        ...
        assert_eq!(file.path, PathBuf::from(".opencode/instructions.md"));
